...
@section('page_header')
    <h1 class="page-title">
        <i class="voyager-list"></i>{{ __('Menu Builder') . ' (' . __($menu->name) . ')'}}
        <div class="btn btn-success add_item"><i class="voyager-plus"></i> @lang('New') @lang('Menu Item')</div>
    </h1>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 id="m_hd_add" class="modal-title hidden"><i
                                class="voyager-plus"></i> @lang('Create') @lang('Menu Item')</h4>
                    <h4 id="m_hd_edit" class="modal-title hidden"><i
                                class="voyager-edit"></i> @lang('Edit') @lang('Menu Item')</h4>
                </div>
                <form action="" id="m_form" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <label for="type">@lang('Link') @lang('Type')</label>
                        <select id="m_link_type" class="form-control" name="type">
                            <option value="url" selected="selected">@lang('Static') URL</option>
                            <option value="route">@lang('Dynamic Route')</option>
                        </select><br>
                        <div id="m_url_type">
                        ...
                        <div id="m_route_type">
                            ...
                            <label for="parameters">@lang('Route parameters') (@lang('Optional'))</label>
                        ...
                        <label for="icon_class">@lang('Font Icon class') (<a
                                    href="{{ admin_asset('fonts/admin/icons-reference.html') }}"
                                    target="_blank">@lang('View')</a>)</label>
                        <input type="text" class="form-control" id="m_icon_class" name="icon_class"
                               placeholder="@lang('Icon Class') (@lang('Optional'))"><br>
                        <label for="color">@lang('Color in RGB or hex') (@lang('Optional'))</label>
                        <input type="color" class="form-control" id="m_color" name="color"
                               placeholder="@lang('Color') (@lang('ex.') #ffffff @lang('or') rgb(255, 255, 255)"><br>
                        <label for="target">@lang('Open In')</label>
                        <select id="m_target" class="form-control" name="target">
                            <option value="_self" selected="selected">@lang('Same Tab/Window')</option>
                            <option value="_blank">@lang('New Tab/Window')</option>
                        </select>
